...
const releases: ReleaseNote[] = [
  ...
  },
  {
    ...
    highlights: [
      {
        ...
        description: 'Automatic builds published to GitHub for easy downloads',
      },
      {
    ...
    changes: [
      'Migrated to GitHub Releases for binary distribution',
          ...
          <div className="container">
            <div className="mx-auto max-w-xl text-center">
              ...
              <div className="flex items-center justify-center gap-4">
                <a
                  href="https://github.com/wellnessatwork/lumina/releases"
                  target="_blank"
